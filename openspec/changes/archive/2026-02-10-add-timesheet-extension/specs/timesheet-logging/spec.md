...
Users SHALL be able to create time entries with hours, date, optional description, and activity type.
...
Users SHALL be able to edit their own time entries.
...
Users SHALL be able to delete their own time entries with confirmation.
...
- **AND** the work item total hours SHALL be updated
